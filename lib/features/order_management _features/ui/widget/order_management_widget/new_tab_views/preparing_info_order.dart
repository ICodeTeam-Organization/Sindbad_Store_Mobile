...
class PreparingInfoOrder extends StatefulWidget {
  const PreparingInfoOrder({
    super.key,
    this.orderNumber,
    this.billNumber,
  ...
  @override
  State<PreparingInfoOrder> createState() => _PreparingInfoOrderState();
}

class _PreparingInfoOrderState extends State<PreparingInfoOrder> {
  ...
  void _scrollListener() {
    ...
    if (currentPostions >= 0.7 * maxScrollLenght) {
      BlocProvider.of<AllOrderCubit>(context)
          .fetchAllOrder(10, 3, '', false, pageNumber: 1);
    }
  }
