...
class UrgentPreparingInfoOrder extends StatefulWidget {
  const UrgentPreparingInfoOrder({
    super.key,
    this.orderNumber,
    this.billNumber,
    this.clock,
  ...
  @override
  State<UrgentPreparingInfoOrder> createState() =>
      _UrgentPreparingInfoOrderState();
}

class _UrgentPreparingInfoOrderState extends State<UrgentPreparingInfoOrder> {
