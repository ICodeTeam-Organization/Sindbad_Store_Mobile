...
import 'package:sindbad_management_app/features/offer_management_features/newdate_offer_feature/data/models/add_offer_model/add_offer_model.dart';
import 'package:sindbad_management_app/features/offer_management_features/newdate_offer_feature/data/models/offer_products_model.dart';
...
abstract class NewOfferRemotDataSource {
  Future<List<OfferProductsEntity>> getOfferProducts({int pageNumber = 0});
