...
import 'package:sindbad_management_app/features/products_feature/add_and_edit_product_feature/ui/widgets/custom_card_to_all_attributes_fields.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomCardProductImagesForAddAndEditProduct(
                      cubitAddProduct: cubitAddProduct,
                      mainImageUrlProduct:
                          null, // not used because for edit page
