...
class StopedProductsTap extends StatefulWidget {
  const StopedProductsTap({
    super.key,
  });

  @override
  State<StopedProductsTap> createState() => _StopedProductsTapState();
}

class _StopedProductsTapState extends State<StopedProductsTap> {
  @override
  void initState() {
    super.initState();
    // context
