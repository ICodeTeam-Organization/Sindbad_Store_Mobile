...
class GetUnreadNotiftionUseCase
    extends UseCaseWithParam<GetUnreadNutficonEntity, UnreadNotiftionParams> {
  final NotifictionRepo notifictionRepo;
  GetUnreadNotiftionUseCase({required this.notifictionRepo});
  @override
  Future<Either<Failure, GetUnreadNutficonEntity>> execute(params) {
