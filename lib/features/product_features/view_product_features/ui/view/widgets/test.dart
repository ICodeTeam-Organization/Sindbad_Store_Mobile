...
//         30,
//         (index) => {
//               'name': 'xxxxxxxxxx $index',
//               'id': '$index',
//               'price': '1500',
//               'imageUrl': 'https://via.placeholder.com/100',
//             });
//     final List<Map<String, dynamic>> yyyyy = List.generate(
//         30,
//         (index) => {
//               'name': 'yyyyyyyyyy $index',
//               'id': '$index',
//               'price': '1500',
//               'imageUrl': 'https://via.placeholder.com/100',
//             });
//     final List<Map<String, dynamic>> zzzzz = List.generate(
//         30,
//         (index) => {
//               'name': 'zzzzzzzzzzz $index',
//               'id': '$index',
//               'price': '1500',
//               'imageUrl': 'https://via.placeholder.com/100',
//             });
...
//                         itemCount: xxxxx.length,
//                         itemBuilder: (context, index) {
//                           final product = xxxxx[index];
//                           return Container(
//                             // margin:
//                             //     const EdgeInsets.symmetric(horizontal: 8, vertical: 8),
//                             padding: const EdgeInsets.only(
//                                 top: 26, bottom: 26, left: 7),
